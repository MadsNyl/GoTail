...
func Pagination(data struct {
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var3 = []any{"px-3 py-2 border rounded",
		...
		for i := max(2, data.Page-1); i <= min(data.TotalPages-1, data.Page+1); i++ {
			var templ_7745c5c3_Var6 = []any{"px-3 py-2 border rounded",
		...
		if data.TotalPages > 1 {
			var templ_7745c5c3_Var10 = []any{"px-3 py-2 border rounded",
